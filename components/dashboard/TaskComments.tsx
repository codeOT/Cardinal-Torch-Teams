        ...
        <div className="mt-2 space-y-3">
          ...
          <form onSubmit={handleSubmit} className="flex gap-2">
            <input
              ...
              className="min-w-0 flex-1 rounded-md border border-slate-200 bg-white px-2.5 py-1.5 text-xs text-slate-800 placeholder:text-slate-400 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100 disabled:opacity-60"
            />
            <button
              type="submit"
              disabled={!draft.trim() || posting || mutating}
              className="shrink-0 rounded-md bg-indigo-600 px-2.5 py-1.5 text-xs font-medium text-white hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {posting ? "..." : "Post"}
            </button>
          </form>
